...
See "hbl_sample.m" for sample code on how to call function. The code should output hte following figure (scatter is MD autocorrelation data for single residue, red line is fit generated by fit_int_autocorr)
